...
<button class="btn btn-primary mb-3">
    <a href="{{route('user.create')}}" style="color: inherit; text-decoration: none;">
        <i class="ti-plus"></i>Tambah Data User
    </a>
</button>
<div class="page-body">
                        ...
                        <tr>
                            ...
                            <td class="text-center text-nowrap" style="width: 120px;">
                                <div class="d-flex align-items-center">
                                    <a href="{{ route('user.show', $ds->id) }}"
                                        class="btn btn-outline-primary btn-sm mr-3" title="Lihat">
                                        <i class="ti-eye"></i>
                                    </a>
                                    <a href="{{route('user.edit',$ds['id'])}}"
